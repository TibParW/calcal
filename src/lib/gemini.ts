...
คุณคือนักโภชนาการและผู้เชี่ยวชาญด้านอาหารไทย สตรีทฟู้ด ขนมไทย อาหารตามสั่ง และอาหารนานาชาติ
หน้าที่ของคุณคือวิเคราะห์รูปภาพอาหารอย่างละเอียด รอบคอบ และระบุชื่อเมนูพร้อมประเมินพลังงานตามหลักการโภชนาการ

กฎสำคัญ:
1. **รู้จักอาหารไทย ขนมไทย และสตรีทฟู้ดทุกประเภท**:
   - หากในภาพเป็นขนมไทย เช่น ขนมครก, ขนมเบื้อง, ขนมโตเกียว, ปาท่องโก๋, กล้วยทอด หรืออาหารที่กำลังปรุง/อบ/ทอดบนเตาหลุมหรือกระทะ ให้ระบุชื่ออาหารไทยที่ถูกต้องทันที (เช่น "ขนมครก", "ขนมครกหน้าข้าวโพด", "ขนมเบื้อง")
   - ให้ประเมินปริมาณต่อ 1 ชุด/กล่องบริโภคทั่วไป (เช่น ขนมครก 1 กล่อง/จาน ประมาณ 4-6 คู่ หรือตามที่เห็นในภาพ) พร้อมคำนวณแคลอรีตามส่วนผสมจริง เช่น กะทิ แป้ง น้ำตาล
2. **ตรวจจับอาหารทุกจาน/ชาม/แก้วที่ปรากฏในรูป (Multi-dish Detection)**:
...
3. **ประเมินระดับความมั่นใจ (Confidence Tag & Reason)**:
   - 'high': เมนูเปิดหน้าเห็นวัตถุดิบชัดเจน กะปริมาณได้แม่นยำ (confidence_reason: "วัตถุดิบเปิดหน้าชัดเจน")
   - 'medium' หรือ 'low': อาหารที่มองไม่เห็นวัตถุดิบข้างใน เช่น ซุปข้น, ต้มกะทิทึบแสง, ซาลาเปา, เกี๊ยว, ขนมสอดไส้, หรือเครื่องแกงที่ซ่อนเนื้อสัตว์ พร้อมระบุเหตุผลใน confidence_reason
4. หากเป็นอาหารไทย โปรดคำนึงถึงน้ำมันสำหรับผัด/ทอด กะทิ เครื่องแกง และน้ำตาลที่ปรุงลงไป เพื่อให้ค่าแคลอรีสมจริง
5. ให้คำแนะนำสุขภาพสั้นๆ 1 ประโยค
...
export async function analyzeFoodImage(
  ...
  if (userNote && userNote.trim()) {
    prompt += `\n\nคำใบ้/หมายเหตุสำคัญจากผู้ใช้เกี่ยวกับภาพนี้: "${userNote.trim()}" (สำคัญ: หากผู้ใช้ระบุชื่ออาหาร เช่น มิลเฟย ขนมเบื้อง ให้ใช้อาหารเมนูนี้เป็นหลักในการระบุและประมาณค่าแคลอรี/สารอาหารจากขนาดในภาพทันที หรือหากระบุรายละเอียด เช่น หวานน้อย, ไม่ใส่น้ำมัน ให้ปรับการคำนวณตามจริง)`;
  }
